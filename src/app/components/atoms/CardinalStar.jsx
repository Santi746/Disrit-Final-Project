 ...
 * @returns {JSX.Element} El elemento Cardinal Star renderizado.
 */
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full w-full items-center justify-center">
        ...
        <svg
          viewBox="0 0 100 100"
          className="text-forest-accent/40 absolute h-[80%] w-[80%] animate-[spin_15s_linear_infinite_reverse]"
          fill="none"
          stroke="currentColor"
          strokeWidth="1.5"
        >
        ...
        <svg
          viewBox="0 0 100 100"
          className="text-forest-accent absolute h-[60%] w-[60%]"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
        >
        ...
        <div className="absolute h-2 w-2 rounded-full bg-white opacity-60 blur-[2px]"></div>
      </div>
    </div>
  );
}
