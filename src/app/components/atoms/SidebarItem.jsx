...
export default function SidebarItem({
  ...
  const activeStyles = active
    ...
    : "text-forest-muted hover:text-forest-light";
  const bgHover = active ? "" : "hover:bg-forest-accent-dark";

  return (
    <div
      onClick={onClick}
      className={`group relative flex cursor-pointer flex-col items-center gap-1 rounded-lg p-2 transition-all ${activeStyles} ${bgHover} ${className}`}
    >
