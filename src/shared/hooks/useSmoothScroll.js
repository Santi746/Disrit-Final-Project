...
export const useSmoothScroll = () => {
     ...
     * @param {string} sectionId - El atributo 'uuid' del elemento HTML destino (ej. "category-1").
    ...
    const scrollToSection = useCallback((sectionId, offset = 90) => {
        ...
        if (element) {
            ...
            console.warn(`useSmoothScroll: No se encontró el elemento con el uuid "${sectionId}"`);
        }
    }, []);
