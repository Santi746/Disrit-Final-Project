...
import ServerProfileSettings from "../organisms/settings/ServerProfileSettings";
import MembersSettings from "../organisms/settings/MembersSettings";
import RolesSettings from "../organisms/settings/RolesSettings";
...
export default function ClubSettingsTemplate({ club, onClose }) {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "profile":
        return <ServerProfileSettings club={club} />;
      case "members":
        return <MembersSettings club_uuid={club?.uuid} />;
      case "roles":
        return <RolesSettings club_uuid={club?.uuid} />;
      case "bans":
        return <BansSettings club_uuid={club?.uuid} />;
      default:
        return null;
    }
  };
