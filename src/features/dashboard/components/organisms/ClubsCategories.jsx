...
/**
 * Organismo que muestra los clubes agrupados por sus respectivas categorías.
 * @component ClubsCategories
 *
 * @param {Object} props
  ...
  return (
    <>
      ...
      {categories.map((category) => (
        <section key={category.uuid} className="mb-12 flex flex-col gap-4">
